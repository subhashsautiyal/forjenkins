pipeline {
    ...
    stages {
        stage("Clone Code") {
            agent {
                label 'Demo-Server' // Replace 'your_remote_node_label' with the label of your remote node
            }
            steps {
                echo "Cloning the code"
                git url: "https://github.com/subhashsautiyal/forjenkins.git", branch: "main"
            }
        }
        stage("Build") {
